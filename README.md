...
- Relic Info Page: like 90% done. needs more styling as well as plan to add search functionality
- Prime Sets Page: this is the current placeholder equipment page. it will have all the prime sets matched to the items from the relics along with their prices and ducats. this will be orgnaized by category such as Warframe, Melee, etc
- Price Checker: i plan to use OCR and have you able to screenthos your inventory, prime parts, mods, etc and then get a price search for each item visible on the screen.
